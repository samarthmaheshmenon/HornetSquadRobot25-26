...
public class IntakeManager {
    ...
    public IntakeManager(LinearOpMode LOpMode, HornetRobo HRobo) {
    ...
    {
        while (hornetRobo.IntakeMotor.isBusy())
        {
            ;
        }
    }
