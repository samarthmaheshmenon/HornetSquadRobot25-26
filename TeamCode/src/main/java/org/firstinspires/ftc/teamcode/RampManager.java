...
public class RampManager {
    ...
    public RampManager(LinearOpMode LOpMode, HornetRobo HRobo) {
    ...
    {
        while (hornetRobo.RampMotor.isBusy())
        {
            ;
        }
    }
